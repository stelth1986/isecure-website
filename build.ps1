...
$pages = @(
  ...
  @{ out='alarm-systems\index.html'; rel='../'; src='alarm-systems.html'; title="Alarm Systems Sydney | Back-to-Base Alarms | iSecure"; desc="Detect alarm systems with motion, entry and glass break sensors, monitored 24/7 by our own centre. Family owned, 30+ years. 1300 012 029." },
  ...
  @{ out='intercom\index.html';      rel='../'; src='intercom.html';      title="Video Intercom Systems Sydney | Home and Building | iSecure"; desc="See and speak to visitors from anywhere, unlock remotely, and secure apartment buildings. iSee video intercoms, installed properly." },
  @{ out='monitoring\index.html';    rel='../'; src='monitoring.html';    title="Alarm Monitoring | 24/7 Back-to-Base Centre | iSecure"; desc="Our Alert Monitoring Centre is staffed 24/7, 365 days a year. Instant response and police notification. Put professionals behind your alarm." },
  @{ out='patrols\index.html';       rel='../'; src='patrols.html';       title="Mobile Patrols Sydney | After Hours Business Patrols | iSecure"; desc="After hours mobile patrols and alarm response for businesses. Scheduled and random checks, lock-ups and patrol reports. Call 1300 012 029." },
  ...
  @{ out='locations\index.html';     rel='../'; src='locations.html';     title="Service Areas | Sydney, QLD, VIC and Nationwide | iSecure"; desc="Based in Sydney, protecting properties nationwide through Protect 24x7. One security partner for every site, one monitoring centre." },
  @{ out='sydney\index.html';        rel='../'; src='sydney.html';        title="Security Services Sydney | Kingsgrove Based | iSecure"; desc="Sydney security from a Sydney family: CCTV, alarms and 24/7 monitoring across Greater Sydney and the Central Coast. Call 1300 012 029." },
  ...
  @{ out='victoria\index.html';      rel='../'; src='victoria.html';      title="Security Services Victoria | Melbourne Coverage | iSecure"; desc="Security design, installation and 24/7 monitoring for Melbourne and Victoria through iSecure's Protect 24x7 network." },
